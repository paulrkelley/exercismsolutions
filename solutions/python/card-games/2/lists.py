...
def approx_average_is_average(hand):
    ...
    fl_average = card_average(list((hand[0],hand[-1])))
    median = hand[len(hand)//2]
    return True if fl_average == average or median == average else False
...
def average_even_is_average_odd(hand):
    ...
    """
    even = card_average(hand[0::2]) 
    odd = card_average(hand[1::2])
    return even == odd
